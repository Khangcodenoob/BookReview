# Website review đánh giá sách (Flask)
...
└─ templates\
  ├─ activity_feed.html           # Hoạt động gần đây
  ├─ base.html                    # Khung trang: header/nav, flash, footer, chat widget
  ├─ book_detail.html             # Chi tiết sách + review, votes, comments, tags
  ├─ books_list.html              # Danh sách sách + tìm kiếm, lọc, sắp xếp, phân trang
  ├─ cart.html                    # Giỏ hàng (nếu có)
  ├─ challenges_list.html         # Danh sách thử thách đọc sách
  ├─ chat.html                    # Trang chat gợi ý (sử dụng static/chat.js)
  ├─ contact_admin.html           # Liên hệ admin
  ├─ faq.html                     # Câu hỏi thường gặp
  ├─ help.html                    # Trợ giúp
  ├─ index.html                   # Trang chủ: sách mới, top tuần, trending
  ├─ login.html                   # Đăng nhập
  ├─ macros.html                  # Macro Jinja dùng chung
  ├─ my_challenges.html           # Thử thách của tôi
  ├─ my_followers.html            # Người theo dõi tôi
  ├─ my_following.html            # Tôi đang theo dõi
  ├─ my_shelves.html              # Kệ sách của tôi
  ...
  ├─ privacy.html                 # Chính sách riêng tư
  ├─ profile.html                 # Trang cá nhân: avatar, bookmarks, review của tôi
  ├─ register.html                # Đăng ký
  ├─ report_bug.html              # Báo lỗi
  ├─ review_form.html             # Form viết review
  ├─ support.html                 # Hỗ trợ
  ├─ terms.html                   # Điều khoản sử dụng
  ├─ user_profile.html            # Hồ sơ người dùng khác
  ...
  │   └─ order_detail.html        # Chi tiết đơn hàng (admin)
  ├─ partials/
  │   └─ donate_widget.html       # Widget donate (nếu có)
